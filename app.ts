document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', function(event: Event) {
        ...
        const experienceEntries = Array.from(document.querySelectorAll('.experience-entry')) as HTMLElement[];
        ...
        // Gather skills data
        const skillEntries = Array.from(document.querySelectorAll('.skills-entry input[name="skills[]"]')) as HTMLInputElement[];
